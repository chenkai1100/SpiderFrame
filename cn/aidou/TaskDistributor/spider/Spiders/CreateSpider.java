...
public class CreateSpider implements ISpiderMan{
	...
	public CreateSpider(int Depth) {
		this.Depth = Depth;
		uRLLinkDao = new URLLinkDao();
		setCreateObjectTime();
	}
	/**
	 * 设置爬虫名字
	 ...
	 * @return
	 */
	public void setSpiderName(int SpiderID) {
		this.SpiderID = SpiderID;
		SpiderName = "爬虫" + SpiderID;
	}
	...
	public void spiderManURL(){
		List<UrlQueue> li = uRLLinkDao.selectURL();
